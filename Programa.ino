...
//Modulo rele(iluminação):9
//Botao desliga iluminação:8
//Modulo LDR:A1
...
int umidadeSolo = 0;
int portaLed = 9; //Porta a ser utilizada para ligar o rele quem em seguida liga o lampada  
